...
<div class="container">
    <div class="card card-container">
        ...
        <form class="form-signin">
            ...
            <input type="text" ng-class="{'error-login': dataLoginError.user_login == true }" id="inputEmail" ng-model="dataLogin.user_login" class="form-control" placeholder="Login/Email" required autofocus>
            <input type="password" ng-class="{'error-login': dataLoginError.user_senha == true }"  id="inputPassword" ng-model="dataLogin.user_senha" class="form-control" placeholder="Senha" required>

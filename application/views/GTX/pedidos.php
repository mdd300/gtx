                        ...
                        <div class="content table-responsive table-full-width">
                            ...
                            <table id="pedidoTable" class="table table-hover table-striped" >
                                ...
                                <tr ng-repeat="pedido in pedidos">
                                    ...
                                    <td>
                                        <a id="popoverData" target="_blank" href="<?=base_url()?>home/editPDF/?id={{pedido.pedido_id}}"  data-content="Editar dados do cliente" rel="popover" data-original-title="Editar"><img style="    height: 12px;

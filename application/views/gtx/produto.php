                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="produto_nome" disabled ng-model="produto.produto_nome" type="text" class="form-control" placeholder="Nome do Produto" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Preço </label>
                                        <input name="produto_preco" disabled ng-model="produto.produto_preco" type="tel" class="form-control input-preco" placeholder="Preço do Produto" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div ng-repeat="variante in produto.produto_variantes">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="variante_nome" disabled ng-model="variante.variante_nome" type="text" class="form-control" placeholder="Nome da variante" >
                                    </div>
                                </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="Tipo" name="Tipo" class="form-control" disabled>
                                                <option value="{{variante.variante_tipo}}" selected>{{variante.variante_tipo}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div ng-repeat="opcao in variante.opcoes" ng-if="variante.variante_tipo == 'Opções'">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="opcao_nome" disabled ng-model="opcao.opcao_nome" type="text" class="form-control" placeholder="Opção" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
